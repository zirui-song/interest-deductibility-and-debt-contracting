...
*** Truncating
gen ie_excess_treat = excess_interest_scaled if excess_interest_scaled > 0.3
...
*** quartile splits
gen ie_excess_q4 = 1 if excess_interest_scaled > 0.9
gen ie_excess_q3 = 1 if inrange(excess_interest_scaled, 0.6, 0.9)
gen ie_excess_q2 = 1 if inrange(excess_interest_scaled, 0.30001, 0.5999)
gen ie_excess_q1 = 1 if inrange(excess_interest_scaled, 0, 0.3)
...
local treat_quartiles "ie_excess_q2 ie_excess_q2_post ie_excess_q3 ie_excess_q3_post ie_excess_q4 ie_excess_q4_post"
